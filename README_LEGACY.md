# Legacy SynthWave '84 README

This file is kept as a historical reference for the upstream [SynthWave '84](https://github.com/robb0wen/synthwave-vscode) project that Kawaii VS Code Color is based on. Current project usage and packaging instructions live in [README.md](./README.md).

Original upstream content follows.
...
Locate [`kawaii_synthwave.css`](./kawaii_synthwave.css) either in this extension's VS code install directory, or in this repository. Alternatively, if you want the browser chrome updates without the text glow you can use [`kawaii_synthwave-noglow.css`](./kawaii_synthwave-noglow.css).
...
```
{
  "vscode_custom_css.imports": [
    "file:///Users/{your username}/kawaii_synthwave.css"
    ]
}
```
...
{
  "vscode_custom_css.imports": [
    "file:///C:/Users/{your username}/kawaii_synthwave.css"
    ]
}
```
